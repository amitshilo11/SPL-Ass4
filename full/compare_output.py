...
def output_check():
    ...
    [print(f'Mismatch in line {i} value {j}') for i, j in itertools.product(range(cmp.shape[0]), range(cmp.shape[1])) if
     cmp[i, j] == False];
